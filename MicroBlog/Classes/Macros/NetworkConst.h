 ...
 *  登录
 */
extern NSString * const kNetworkClientLogin;
extern NSString * const kRequestTagLogin;

/**
 *  登出
 */
extern NSString * const kNetWorkClientLogou;
extern NSString * const kRequestTagLogout;
